...
<script>
    jQuery(document).ready(function($) {
        ...
        $('.wc-block-components-radio-control-accordion-option').find('label[for="radio-control-wc-payment-method-options-mpgs_gateway"]').after('<img class="p-5" src="https://www.netcommercepay.com/logo/NCseal_M.gif" border="0" alt="NetCommerce Security Seal">');
    });
</script>
<?php wp_footer(); ?>
</body>
