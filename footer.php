...
<script>
    jQuery(document).ready(function($) {
        ...
        $('.wc-block-components-radio-control-accordion-option label[for="radio-control-wc-payment-method-options-mpgs_gateway"] .wc-block-components-radio-control__option-layout').after('<img src="https://www.netcommercepay.com/logo/NCseal_M.gif" border="0" alt="NetCommerce Security Seal">');
    });
</script>
<?php wp_footer(); ?>
</body>
