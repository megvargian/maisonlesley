...
<script>
    jQuery(document).ready(function($) {
        ...
        $('label[for|="radio-control-wc-payment-method-options-mpgs_gateway"] wc-block-components-radio-control-accordion-content').append('<img src=”https://www.netcommercepay.com/logo/NCseal_M.gif” border=”0” alt=”NetCommerce Security Seal”>');
    });
</script>
<?php wp_footer(); ?>
</body>
