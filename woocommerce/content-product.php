...
<div id="product-<?php echo $product_id; ?>" class="cat-single-main-product" <?php wc_product_class( '', $product ); ?>>
        ...
        if ($attachment_ids && !empty($attachment_ids)) {
                ...
                $first_image_url = ($counter_products % 5 == 0) ? wp_get_attachment_image_src($first_image_id, 'full') : wp_get_attachment_image_src($first_image_id, 'full'); // Get the URL of the first image
        } ?>
        ...
        <?php
                ...
                $image_url = ($counter_products % 5 == 0) ? wp_get_attachment_image_src($attachment_id, 'full') : wp_get_attachment_image_src($attachment_id, 'full');
